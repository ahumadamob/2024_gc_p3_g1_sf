...
public class CartController {
    ...
    public ResponseEntity<APIResponse<List<Cart>>> getCarts() {
        ...
        return carts.isEmpty() ? ResponseUtil.notFound("No se encontraron carritos") : ResponseUtil.success(carts);
    }
    ...
    public ResponseEntity<APIResponse<List<Cart>>> getCartsByTotal(@RequestParam float start, float end) {
        ...
        return carts.isEmpty() ? ResponseUtil.notFound("No se encontraron carritos entre esos valores.") : ResponseUtil.success(carts);
    }
